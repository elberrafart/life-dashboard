    ...
    <>
      ...
      >
        ...
        <div className="header-hide-mobile" style={{ alignItems: 'center', gap: 12, flexShrink: 0 }}>
          ...
          <button onClick={onSettingsOpen} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--text3)', fontSize: 18, padding: 8, borderRadius: 8, transition: 'color 150ms' }} title="Settings" onMouseOver={e => (e.currentTarget.style.color = 'var(--silver)')} onMouseOut={e => (e.currentTarget.style.color = 'var(--text3)')}>⚙</button>
          {isAdmin && (
